...
def save_clicked_flag(value):
    with open('clicked_flag.txt', 'w') as file:
...
image_txtlst = PhotoImage(file= os.path.join(PATH_IMAGES,"txtchbx.png"))
txtlst = Entry(tab_chbx, font=("Comic Sans MS",20),width=30, borderwidth=0)
txtlst.place(x=300,y=100)
