...
def cht_ip():
    ...
    save_diem_btn = Button(cht_input,text = "save", font= ("Comic Sans MS", 14), bg = 'yellow', command = luu_diem, height=1, width=10)
    save_diem_btn.pack()
    def mo_diem():
        try:
            load_diem('A2', tx1t)
...
nhapdiem = Button(tab_cht, height= 20, width= 100, text = "nhapdiem", bg='yellow', command= cht_ip)
nhapdiem.pack()
